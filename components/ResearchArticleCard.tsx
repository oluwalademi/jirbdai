  ...
  return (
    <div className="article-card-template">
      ...
      <div className="justify-start p-0">
        ...
        <div className="article-title h3-text text-[18px] font-medium text-curiousblue">
          {title}
        </div>
      </div>

      {/* Author Section */}
      <div className="author-container container flex w-full flex-col gap-x-4 gap-y-2">
